export const randomizer = (level, range, enemy) => {
    ...
    if(!enemy){
        ...
        if(name === "Human"){
            ...
            HP = Math.round(Math.random() * (lvl*3)) + Math.round(5*(lvl*0.75))
        ...
        if(name === "Hobbit"){
            ...
            HP = Math.round(Math.random() * (lvl*2)) + Math.round(4*(lvl*0.75))
            accuracy = 100
        }
        if(name === "Elf"){
            strength = Math.ceil(Math.random() * (lvl+1)) + 1 + Math.floor(lvl/2)
            defense = Math.round(Math.random() * (lvl-1))
            HP = Math.round(Math.random() * (lvl*2)) + Math.round(3*(lvl*0.75))
        ...
        strength = Math.floor(Math.random() * Math.ceil(lvl*1.2)) + 1
